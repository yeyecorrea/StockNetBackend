    ...
    public partial class AddEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriasMateriaPrima", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CostosFijos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_materiaPrimas_CategoriasMateriaPrima_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "CategoriasMateriaPrima",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacturaProveedor = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    DatosDeEnvio = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventarioInicial = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DetallesCompra_materiaPrimas_MateriaPrimaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_materiaPrimas_CategoriaId",
                table: "materiaPrimas",
                column: "CategoriaId");
